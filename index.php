...
<head>
	...
	<link rel="stylesheet" href="plugins/magiczoom/magiczoom.css">
	<!-- DataTables -->
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<b>E-Voting Ketua BEM (Badan Eksekutif Mahasiswa) Fakultas Ilmu Komputer</b>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text font-weight-light"> E-Voting Ketua BEM</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="foto/avatar.jpg" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=laporan-kotak" class="nav-link">
										<i class="nav-icon far fa-circle text-info"></i>
										<p>Kotak Suara</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=laporan-suara" class="nav-link">
										<i class="nav-icon far fa-circle text-info"></i>
										<p>Perolehan Suara</p>
									</a>
								</li>
						...
						<li class="nav-item">
							<a href="?page=data-data" class="nav-link">
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=data-calon-panitia" class="nav-link">
										<i class="nav-icon far fa-circle text-success"></i>
										<p>Data Kandidat</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=data-pemilih-panitia" class="nav-link">
										<i class="nav-icon far fa-circle text-success"></i>
										<p>Data Pemilih</p>
									</a>
								</li>
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				case 'del-calon':
					...
					break;
				case 'detail-calon':
					include "admin/calon/detail_calon.php";
					break;	

					//calon panitia
				case 'data-calon-panitia':
					include "panitia/calon/data_calon.php";
					break;
				case 'edit-calon-panitia':
					include "panitia/calon/edit_calon.php";
					break;
				case 'del-calon-panitia':
					include "panitia/calon/del_calon.php";
					break;
				...
				case 'del-pemilih':
					...
					//Pemilih Panitia
				case 'data-pemilih-panitia':
					include "panitia/pemilih/data_pemilih.php";
					break;
				case 'edit-pemilih-panitia':
					include "panitia/pemilih/edit_pemilih.php";
					break;
				...
				case 'data-suara':
                  ...
                  //Tampil Data
				case 'data-data':
                  include "admin/data/data_data.php";
				  break;
				case 'edit-data':
                  include "admin/data/edit_data.php";
                  break;
                ...
                //Laporan
				case 'laporan-suara':
                  include "report/data_suara.php";
				  break;
				case 'laporan-kotak':
                  include "report/data_kotak.php";
                  break;
                case 'print-laporan-kotak':
                  include "report/print_data_kotak.php";
                  break;
                case 'print-laporan-suara':
                  include "report/print_data_suara.php";
                  break;  
              //default
              default:
...
<code class="text-primary">
	...
	<script src="plugins/magiczoom/magiczoom.js"></script>
