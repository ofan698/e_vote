		...
		<div class="table-responsive">
            ...
            ?>
					...
					<tr>
						...
						<td align="center">
							<a href="foto/<?php echo $data['foto_pengguna']; ?>" width="100px" class="MagicZoom" rel="zoom-id:zoom;opacity-reverse:true;">	
							<img src="foto/<?php echo $data['foto_pengguna']; ?>" width="100px" />
						</td>
						<td>
							<?php echo $data['email']; ?>
						</td><td>
						...
						<td>
							<a href="?page=edit-pemilih-panitia&kode=<?php echo $data['id_pengguna']; ?>" title="Ubah"
