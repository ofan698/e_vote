			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="foto/<?php echo $data['foto_ktm']; ?>" width="150px" class="MagicZoom" rel="zoom-id:zoom;opacity-reverse:true;">
							<img src="foto/<?php echo $data['foto_ktm']; ?>" width="150px" />
						</td>

						<td align="center">
							<a href="foto/<?php echo $data['foto_transkrip']; ?>" width="150px" class="MagicZoom" rel="zoom-id:zoom;opacity-reverse:true;">
							<img src="foto/<?php echo $data['foto_transkrip']; ?>" width="150px" />
						</td>

						<td align="center">
							<a href="foto/<?php echo $data['foto_lk']; ?>" width="150px" class="MagicZoom" rel="zoom-id:zoom;opacity-reverse:true;">
						...
						<td>
							<a href="?page=edit-calon-panitia&kode=<?php echo $data['id_calon']; ?>" title="Ubah"
							 class="btn btn-success btn-sm">
								<i class="fa fa-edit"></i>
							</a>
							<a href="?page=del-calon-panitia&kode=<?php echo $data['id_calon']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
